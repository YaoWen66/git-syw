...
public class UserController {
    ...
    public ResultObj addUser(UserVo userVo) {
        try {
            ...
            String s = IdUtil.simpleUUID().toUpperCase();
            userVo.setSalt(s);//设置盐
            userVo.setPwd(new Md5Hash(Constast.USER_DEFAULT_PWD,s,2).toString());//设置密码
    ...
    public ResultObj resetPwd(Integer id) {
        try {
            ...
            String s = IdUtil.simpleUUID().toUpperCase();
            user.setSalt(s);//设置盐
            user.setPwd(new Md5Hash(Constast.USER_DEFAULT_PWD,s,2).toString());//设置密码
